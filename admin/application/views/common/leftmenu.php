        ...
        <div class="main-container ace-save-state" id="main-container">
            ...
            <div id="sidebar" class="sidebar                  responsive                    ace-save-state">
                ...
                <ul class="nav nav-list">
                    <li class="">
                        <a href="<?php echo base_url('index.php/jithireAdmin/dashboard'); ?>">
                    ...
                    <li class="">
                        <a href="<?php echo base_url('index.php/jithireAdmin/company_details'); ?>">
                        ...
                        <ul class="submenu nav-show" style="display: block;">
                            <li>
                                <a href="<?php echo base_url('index.php/jithireAdmin/posted_jobs');  ?>">
                    ...
                    <li class="">
                        <a href="<?php echo base_url('index.php/jithireAdmin/candidate_details');  ?>">
                     ...
                     <li class="">
                        <a href="<?php echo base_url('index.php/jithireAdmin/logout');  ?>">
