                          ...
                          <div id="candidate_view" class="mTop-20">
                            <form method="post" id="candidate_form" class="single-form">
                              <div class="col-xs-12" id="agreement1div">
                                  <div class="checkbox">
                                      <input name="agreement1" id="agreement1" type="checkbox" value="1"/>
                                      <label for="agreement1">I am currently available and ready to join in 24 hrs</label>
                                  </div>
                              </div>
                              <div class="col-xs-12" id="agreement2div">
                                  <div class="checkbox">
                                      <input name="agreement2" id="agreement2" type="checkbox" required="required" />
                              ...
                              <div class="col-xs-12" id="agreement3div">
                                  <div class="checkbox">
                                      <input name="agreement3" id="agreement3" type="checkbox" required="required"/>
                              ...
                              <div class="col-xs-12" id="agreement4div" >
                                  <div class="checkbox">
                                      <input name="agreement4" id="agreement4" type="checkbox" required="required"/>
